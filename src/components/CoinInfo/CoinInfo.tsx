...
const CoinInfo = ({ data, currency, isLoading }: Props) => {
      ...
      {!isLoading && (
        <section className={style.container}>
          ...
          <div className={style.description}>
            <h3>About</h3>
            <p dangerouslySetInnerHTML={{ __html: data?.description.en.split('. ')[0] + '.' }} />
          </div>
          ...
          <div className={style.details}>
            <div className={style.info}>
              ...
              <span>
                ${data?.market_data.low_24h[currency.toLowerCase()].toLocaleString('en-US')}
              </span>
            </div>
            <div className={style.info}>
              <span className={style.tittle}>24 Hour High</span>
              <span>
                ${data?.market_data.high_24h[currency.toLowerCase()].toLocaleString('en-US')}
              </span>
            </div>
            <div className={style.info}>
